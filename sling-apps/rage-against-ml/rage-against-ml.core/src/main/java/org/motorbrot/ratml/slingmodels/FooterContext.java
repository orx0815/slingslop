 ...
 * (identified by {@code sling:resourceType="ratml/pages/homepage"}),
 ...
 * <pre>
 * {@code
 * <footer data-sly-use.footerCtx="org.motorbrot.ratml.slingmodels.FooterContext"
...
public class FooterContext {
   ...
   * The homepage is identified by having sling:resourceType="ratml/pages/homepage".
   *
   ...
   * @return true if the resource type is "ratml/pages/homepage"
   */
  private boolean isHomepageResourceType(Resource res) {
    ...
    return "ratml/pages/homepage".equals(resourceType);
  }
