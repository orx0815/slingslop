...
/**
 * Backing model for the {@code ratml/components/parsys} paragraph system.
 *
 * <p>
 ...
 * {@code /apps/ratml/components/} so the "add component" picker can show a
 ...
 * (e.g. {@code ratml/components/feature-image}).
 * </p>
 */
...
public class ParsysModel {
    ...
    static final String COMPONENT_RESOURCE_TYPE_PREFIX = "ratml/components/";
