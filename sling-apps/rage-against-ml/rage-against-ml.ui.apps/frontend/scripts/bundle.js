#!/usr/bin/env node
/**
 * Build script for Rage Against the Machine Learning UI assets.
 *
 ...
 *
 * Output layout under  ../src/main/content/jcr_root/apps/ratml/
 *
 *   js/
 *     editor/
...
const JCR_BASE = path.resolve(ROOT, '../src/main/content/jcr_root/apps/ratml');
...
async function build() {
  console.log('Building Rage Against the Machine Learning UI assets…\n');
...
async function watch() {
  console.log('Watching Rage Against the Machine Learning UI assets (dev builds only)…');
