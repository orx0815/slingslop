#!/usr/bin/env node
/**
 * Build script for Sling Bench UI assets.
 *
 ...
 *
 * Output layout under  ../src/main/content/jcr_root/apps/sling-bench/
 *
 *   js/
 *     editor/
...
const JCR_BASE = path.resolve(ROOT, '../src/main/content/jcr_root/apps/sling-bench');
...
async function build() {
  console.log('Building Sling Bench UI assets…\n');
...
async function watch() {
  console.log('Watching Sling Bench UI assets (dev builds only)…');
