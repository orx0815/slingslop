#!/usr/bin/env node
/**
 * Build script for Disco Dingo UI assets.
 *
 ...
 *
 * Output layout under  ../src/main/content/jcr_root/apps/disco-dingo/
 *
 *   js/
 *     editor/
...
const JCR_BASE = path.resolve(ROOT, '../src/main/content/jcr_root/apps/disco-dingo');
...
async function build() {
  console.log('Building Disco Dingo UI assets…\n');
...
async function watch() {
  console.log('Watching Disco Dingo UI assets (dev builds only)…');
