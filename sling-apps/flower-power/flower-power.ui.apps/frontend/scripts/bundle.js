#!/usr/bin/env node
/**
 * Build script for Flower Power UI assets.
 *
 ...
 *
 * Output layout under  ../src/main/content/jcr_root/apps/flower-power/
 *
 *   js/
 *     editor/
...
const JCR_BASE = path.resolve(ROOT, '../src/main/content/jcr_root/apps/flower-power');
...
async function build() {
  console.log('Building Flower Power UI assets…\n');
...
async function watch() {
  console.log('Watching Flower Power UI assets (dev builds only)…');
