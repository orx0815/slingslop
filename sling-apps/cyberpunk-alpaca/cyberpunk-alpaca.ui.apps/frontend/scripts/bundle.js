#!/usr/bin/env node
/**
 * Build script for Cyberpunk Alpaca UI assets.
 *
 ...
 *
 * Output layout under  ../src/main/content/jcr_root/apps/cyberpunk-alpaca/
 *
 *   js/
 *     editor/
...
const JCR_BASE = path.resolve(ROOT, '../src/main/content/jcr_root/apps/cyberpunk-alpaca');
...
async function build() {
  console.log('Building Cyberpunk Alpaca UI assets…\n');
...
async function watch() {
  console.log('Watching Cyberpunk Alpaca UI assets (dev builds only)…');
