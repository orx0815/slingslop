#!/usr/bin/env node
/**
 * Build script for Alf vs Agent Smith UI assets.
 *
 ...
 *
 * Output layout under  ../src/main/content/jcr_root/apps/alf-vs-agent/
 *
 *   js/
 *     editor/
...
const JCR_BASE = path.resolve(ROOT, '../src/main/content/jcr_root/apps/alf-vs-agent');
...
async function build() {
  console.log('Building Alf vs Agent Smith UI assets…\n');
...
async function watch() {
  console.log('Watching Alf vs Agent Smith UI assets (dev builds only)…');
