...
docs/                 ← Agent skills and concept documentation
```
...
Skills are detailed instruction sets for specific tasks:

| Skill | File | Purpose |
|---|---|---|
| **New Sling App with Agent Smith** | `docs/new-sling-app.md` | Scaffold a complete new Sling application from scratch via guided conversation |
...
| `docs/new-sling-app.md` | Agent Smith skill: full project scaffolding instructions |
